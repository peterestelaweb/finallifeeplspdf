...
async function testLegalModal() {
    console.log('🔍 Starting Legal Modal Functionality Test...');
    ...
    try {
        // Test 1: Navigate to the website
        ...
        await page.screenshot({
            path: './test-results/modal-test/before-click.png',
            fullPage: true
        });
        ...
        await page.screenshot({
            path: './test-results/modal-test/after-click.png',
            fullPage: true
        });
        ...
        await page.screenshot({
            path: './test-results/modal-test/final-state.png',
            fullPage: true
        });
        ...
        await page.screenshot({
            path: './test-results/modal-test/error-state.png',
            fullPage: true
        });
    ...
    console.log('📁 Check test-results/modal-test/ for screenshots and video');
}
