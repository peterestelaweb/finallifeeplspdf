<?php
/**
 * Versión FINAL simple del formulario de contacto - SIN validaciones complejas
 */
...
try {
    ...
    // Recibir datos (sin campo pregunta)
    ...
    if (empty($nombre) || empty($email) || empty($motivo) || empty($ayuda)) {
        echo json_encode([
            ...
            'debug' => [
                ...
                'email_vacio' => empty($email),
                'motivo_vacio' => empty($motivo),
                'ayuda_vacio' => empty($ayuda),
